...
// جلب فواتير الكهرباء
$sql = "SELECT * FROM bills WHERE user_id = ? AND bill_type = 'مياه' ORDER BY id DESC";
...
<head>
    <meta charset="UTF-8">
    <title>دفع فاتورة المياه</title>

    <style>
        /* ================= HEADER ================= */
        .header-section{
            height:80vh;
            background:url('../../assets/img/water2.jpg') center/cover no-repeat;
            position:relative;
            display:flex;
            align-items:center;
...
<section class="header-section">
    <div class="header-content">
        <div class="header-glass">
            <h1>خدمة دفع فواتير المياه</h1>
            <p style="font-size: 24px">  نقدّم لك خدمة مريحة وآمنة لدفع فواتير المياه بكل سهولة وفي أي وقت.</p>
            <p style="font-size: 24px"> يمكنك اختيار المبلغ المناسب، تنفيذ عملية الدفع بسرعة، والاطلاع على سجل فواتيرك السابقة بكل وضوح.</p>
            <p style="font-size: 24px"> نسعى لتوفير تجربة سلسة تضمن لك توفير الوقت والجهد مع أعلى مستويات الأمان.</p>
        </div>
    </div>
</section>
...
<section class="bills-section">
    <h2 style="text-align:center;margin-bottom:25px; color:#173b64">فواتير المياه السابقة</h2>
